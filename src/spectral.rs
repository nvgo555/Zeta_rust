//! Spectral Projectors and $T_3$ Dynamics.
//!
//! Implements the Sylvester projectors that separate the ring into its 1D and 2D Galois orbits,
//! and the application of the unimodular matrix $T_3 \in \mathrm{SL}(3, \mathbb{Z})$.
...
/// Applies the $T_3$ transition matrix exactly $n$ times.
///
/// $T_3$ has characteristic polynomial $X^3 - X^2 - X - 1$ matching the ring extension.
#[inline(always)]
