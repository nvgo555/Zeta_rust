...
> **High-Performance Rust Port**: The core engine of Zeta has been fully ported to Rust for extreme performance (>1,000,000x speedups on core tensor field operations). The primary implementation now lives in the root directory (via `src/` and `Cargo.toml`).
...
- [1. Mathematical Preliminaries](#1-mathematical-preliminaries)
  - [1.1 The Prime Field $\mathbb{F}{13}$](#11-the-prime-field-mathbbf13)
  - [1.2 Polynomial Rings and Quotient Construction](#12-polynomial-rings-and-quotient-construction)
  - [1.3 Representation of Ring Elements](#13-representation-of-ring-elements)
  - [1.4 The Unit Group](#14-the-unit-group)
- [2. The Base Ring $\mathbb{Z}{13}[\eta]$](#2-the-base-ring-mathbbz13eta)
  - [2.1 Ring Arithmetic](#21-ring-arithmetic)
  - [2.2 The Element $\eta$ and Its Powers](#22-the-element-eta-and-its-powers)
- [3. Spectral Theory of $T_3$](#3-spectral-theory-of-t_3)
  - [3.1 Definition and Basic Properties](#31-definition-and-basic-properties)
  - [3.2 Eigenvalue Structure](#32-eigenvalue-structure)
  - [3.3 Sylvester Spectral Decomposition](#33-sylvester-spectral-decomposition)
- [4. The Ultrametric Kernel](#4-the-ultrametric-kernel)
  - [4.1 p-adic Valuation](#41-p-adic-valuation)
  - [4.2 Kernel Definition](#42-kernel-definition)
  - [4.3 Strong Triangle Inequality](#43-strong-triangle-inequality)
  - [4.4 Tree Structure](#44-tree-structure)
- [5. Galois Symmetry and the $S_3$ Action](#5-galois-symmetry-and-the-s_3-action)
  - [5.1 The Galois Group](#51-the-galois-group)
  - [5.2 Permutation Representation](#52-permutation-representation)
  - [5.3 Conjugation Operator](#53-conjugation-operator)
  - [5.4 Parallel Orbit Evolution](#54-parallel-orbit-evolution)
- [6. Chinese Remainder Theorem Decomposition](#6-chinese-remainder-theorem-decomposition)
  - [6.1 The CRT Isomorphism](#61-the-crt-isomorphism)
  - [6.2 Component Maps](#62-component-maps)
  - [6.3 Reconstruction](#63-reconstruction)
- [7. Architecture](#7-architecture)
  - [7.1 System Overview](#71-system-overview)
  - [7.2 Design Principles](#72-design-principles)
- [8. Deterministic Embeddings and Positional Encoding](#8-deterministic-embeddings-and-positional-encoding)
  - [8.1 ZRingEmbed](#81-zringembed)
  - [8.2 TatePE](#82-tatepe)
- [9. Spectral Attention Mechanism](#9-spectral-attention-mechanism)
  - [9.1 Sylvester Channel Split](#91-sylvester-channel-split)
  - [9.2 Tree Kernel Mixing](#92-tree-kernel-mixing)
  - [9.3 Local Q/K/V Projections](#93-local-qkv-projections)
  - [9.4 Born Normalization](#94-born-normalization)
  - [9.5 Output Projection](#95-output-projection)
- [10. Witt Vector Head and Hensel Lifting](#10-witt-vector-head-and-hensel-lifting)
  - [10.1 Witt Vector Construction](#101-witt-vector-construction)
  - [10.2 Head Synchronization](#102-head-synchronization)
  - [10.3 Hensel Lifting](#103-hensel-lifting)
- [11. MERA Tensor Network](#11-mera-tensor-network)
  - [11.1 Hierarchical Coarse-Graining](#111-hierarchical-coarse-graining)
  - [11.2 Dynamic Depth](#112-dynamic-depth)
- [12. Geometric Quantum Mechanics](#12-geometric-quantum-mechanics)
  - [12.1 State Space](#121-state-space)
  - [12.2 Born Rule](#122-born-rule)
  - [12.3 Density Matrices](#123-density-matrices)
  - [12.4 Quantum Cache](#124-quantum-cache)
- [13. Training via Buchberger-Nullstellensatz](#13-training-via-buchberger-nullstellensatz)
  - [13.1 Error Ideal](#131-error-ideal)
  - [13.2 Witness Polynomial](#132-witness-polynomial)
  - [13.3 Ideal Contribution](#133-ideal-contribution)
  - [13.4 Scatter Update](#134-scatter-update)
  - [13.5 Convergent Decay](#135-convergent-decay)
  - [13.6 Witt Update](#136-witt-update)
  - [13.7 Quantum and Spectral Memory](#137-quantum-and-spectral-memory)
- [14. Autonomous Control Loop](#14-autonomous-control-loop)
  - [14.1 Components](#141-components)
  - [14.2 Scaling Decisions](#142-scaling-decisions)
  - [14.3 Control Flow](#143-control-flow)
- [15. Tokenization](#15-tokenization)
  - [15.1 Byte Tokenizer (`tokenise`)](#151-byte-tokenizer-tokenise)
  - [15.2 DNA Codon Tokenizer (`dna_tokenise`)](#152-dna-codon-tokenizer-dna_tokenise)
  - [15.3 Trigram Tokenizer (`trigram_tokenise`)](#153-trigram-tokenizer-trigram_tokenise)
- [16. Axiom Verification System](#16-axiom-verification-system)
- [17. Performance Characteristics](#17-performance-characteristics)
  - [Core Operations & Speedup Comparison](#core-operations-speedup-comparison)
  - [Detailed Scaling Benchmarks](#detailed-scaling-benchmarks)
- [18. Module Reference](#18-module-reference)
  - [Core Algebra](#core-algebra)
  - [Kernel and Geometry](#kernel-and-geometry)
  - [Transform and Arithmetic](#transform-and-arithmetic)
  - [Quantum and Spectral](#quantum-and-spectral)
  - [Model, Attention, and Hybrid](#model-attention-and-hybrid)
  - [Learning and Autonomy](#learning-and-autonomy)
  - [Planning and Control](#planning-and-control)
  - [System and I/O](#system-and-io)
- [19. Usage Examples](#19-usage-examples)
  - [19.1 Rust Port Usage](#191-rust-port-usage)
  - [19.2 Legacy Python Reference Usage](#192-legacy-python-reference-usage)
- [20. Bibliography](#20-bibliography)
- [Author, License, and Version](#author-license-and-version)
<!-- tocstop -->
